...
Last updated: 2026-07-30 · Head: `76a5cce` · **The file is `SHITFIRE.html`, not `index.html`**
...
**Next:** **13f** (instanced vegetation + scatter) — **13e** (near-field terrain LOD patch) shipped
`76a5cce`. Track G is complete except **G20**, PARKED at the user's direction. Board advances through
...
| 13f | G4 | Instanced vegetation + scatter | Opus | **Civilian/military discrimination at 2000 m survives**; no veg on structures/roads; canopy ≤6 m | **NEXT** |
