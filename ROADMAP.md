...
Last updated: 2026-07-30 · Head: `13084ef` · **The file is `SHITFIRE.html`, not `index.html`**
...
**Next:** **G15/G16** (sheaf/fuze), then **G10** (FIRE UNIT STATUS exchange, borrowed NGF shape per research). Research is on file in DOCTRINE.md §Pre-mission and effects data, `8304ef6`.
...
**Next: G15/G16** (sheaf, fuze), then **G10** (FIRE UNIT STATUS exchange). G21 already closed above.
