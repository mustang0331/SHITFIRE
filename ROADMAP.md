...
Last updated: 2026-07-30 · Head: `5384cf1` · **The file is `SHITFIRE.html`, not `index.html`**
...
**Next:** **12h** (smoke + illumination mission types) — **13i** (optics presentation — vignette,
sway) shipped `5384cf1`, closing Track A / stage 13 whole (`13a`–`13i` all DONE). Track G is complete
except **G20**, PARKED at the user's direction. Per the standing order (stage 13 → stage 12 remainder
→ stage 11), board advances to the first not-DONE stage 12 row — 12h's blocker (13c) has been shipped
since 2026-07-29, so it is unblocked.
...
| 12h | **Smoke + illumination** mission types | Opus | Impact-effect hooks fire; illum needs 13c TOD for a night mission to mean anything | **NEXT** — unblocked (13c shipped `999e4c6`; stage 13 now closed whole) |
| 12i | **Wind model** — drifts smoke so it's readable as a tool | Opus | Smoke drift visible and directionally consistent | READY — unblocked (13c shipped) |
