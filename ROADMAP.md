...
Last updated: 2026-07-30 · Head: `64053fe` · **The file is `SHITFIRE.html`, not `index.html`**
...
**Next:** **13e** (near-field terrain LOD patch) — Track G is complete except **G20**, PARKED at the
user's direction. Board advances to the stage 13 visual-overhaul remainder per the standing order.
...
| 13e | G3 | Near-field terrain LOD patch (fixes 33 m facets > 60 m effect radius) | Opus | Burst deviation judgable against micro-relief; no seam z-fight; `groundHit`/`hasLOS` untouched | **NEXT** |
