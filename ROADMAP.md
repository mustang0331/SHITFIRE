...
Last updated: 2026-07-30 · Head: `829caeb` · **The file is `SHITFIRE.html`, not `index.html`**
...
**Next:** **13i** (optics presentation — vignette, sway; 2D canvas/CSS only) — **13h** (persistent
craters + lingering marker smoke + water-splash column) shipped `829caeb`. Track G is complete except
**G20**, PARKED at the user's direction. Board advances through the stage 13 visual-overhaul remainder
...
| 13i | G7 | Optics presentation — vignette, sway (2D canvas/CSS only) | Opus | Mil graduations at full contrast, unencroached | **NEXT** |
