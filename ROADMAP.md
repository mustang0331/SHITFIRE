...
Last updated: 2026-07-30 · Head: `6b7fd3c` · **The file is `SHITFIRE.html`, not `index.html`**
...
optics presentation — vignette, sway).

**Next:** **12i** (wind model) — **12h** (smoke + illumination mission types) shipped `6b7fd3c`. Track
A / stage 13 is whole (`13a`–`13i` all DONE) and Track G is complete except **G20**, PARKED at the
user's direction. Per the standing order (stage 13 → stage 12 remainder → stage 11), board advances to
the next not-DONE stage 12 row — 12i's blocker (13c) has been shipped since 2026-07-29, so it is
unblocked.
...
| 12i | **Wind model** — drifts smoke so it's readable as a tool | Opus | Smoke drift visible and directionally consistent | **NEXT** — unblocked (13c shipped; 12h's smoke screen now gives wind drift something real to act on) |
| 12j | **Degraded optics / dead laser** condition forcing mil-relation ranging | Opus | Laser unavailable; 12b's mil-relation path is the only solution | READY — unblocked (stage 13 now closed whole) |
