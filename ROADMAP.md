...
**Next:** **G18** (per-asset radii off the researched figures — G13's `CONFIG.EFFECTS` structure is where the per-asset band sets go), then **G15/G16** (sheaf/fuze), then **G10** (FIRE UNIT STATUS exchange, borrowed NGF shape per research). Research is on file in DOCTRINE.md §Pre-mission and effects data, `8304ef6`.
