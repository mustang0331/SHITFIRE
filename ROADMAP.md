...
Last updated: 2026-07-30 · Head: `cb8a13d` · **The file is `SHITFIRE.html`, not `index.html`**
...
**Next:** **13g** (shoreline foam + ocean sun glint) — **13f** (instanced vegetation + scatter) shipped
`cb8a13d`. Track G is complete except **G20**, PARKED at the user's direction. Board advances through
the stage 13 visual-overhaul remainder per the standing order.
...
| 13g | G5 | Shoreline foam + ocean sun glint | Opus | 60 fps held; one preallocated `uTime` uniform, no per-frame alloc | **NEXT** |
