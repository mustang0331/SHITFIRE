...
const SPOT_SCN = {
  ...
  defense:     { size: 'SQUAD PLUS — EIGHT OR MORE DISMOUNTS',      // ENEMY2
                 act: 'ADVANCING ON YOUR OBSERVATION POST. YOU ARE THE OBJECTIVE',
                 eq: 'SMALL ARMS AND AT LEAST ONE MACHINE GUN, MOVING LIGHT' },
  occupied:    { size: 'PLATOON MINUS, HOLDING GROUND',             // WORLD2
                 act: 'OCCUPYING A SETTLEMENT. CIVILIANS ARE STILL INSIDE THE STRUCTURES',
                 eq: 'SMALL ARMS, CREW-SERVED WEAPONS ON THE PERIMETER, TWO VEHICLES' },
};
const SPOT_UNIT = [
