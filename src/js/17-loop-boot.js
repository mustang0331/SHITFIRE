...
window.SHITFIRE = { CONFIG, H, fireMission, applyCorrection, FDC, WORLD,
  ...
  // QA hooks for tools/shots.js (additive — the stable interface above is unchanged):
  // the screenshot rig drives TOD and optics states that no keybind reaches directly.
  applyTOD, setVision, onPlayerMessage };
